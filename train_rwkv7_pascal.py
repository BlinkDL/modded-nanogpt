...
if True:
    ...
    load(name="wkv7g", sources=["rwkv_cuda_pascal/wkv7g_op.cpp", f"rwkv_cuda_pascal/wkv7g_v1.cu"], is_python_module=False, verbose=True, extra_cuda_cflags=CUDA_FLAGS+[f"-D_N_={HEAD_SIZE}", f"-D_T_={T}", f"-D_CHUNK_LEN_={CHUNK_LEN}"])
